...
- **Event creation & configuration** — Set up walking competitions, step challenges, 
  ...
  ![A screenshot showing the events web page.](readme_assets/web_screenshots/events_page.png)
- **Participant management** — View registrations, track team or individual progress, 
  ...
  ![A screenshot showing the event creation web page.](readme_assets/web_screenshots/create_event_page.png)
